 ...
 */
@Controller
@RequestMapping("/fmis/pattachment2")
public class BizProductAttachment2Controller extends BaseController {
    private String prefix = "fmis/pattachment2";
    ...
    @RequiresPermissions("fmis:pattachment2:view")
    @GetMapping()
     ...
     * 查询定位器列表
     */
    @RequiresPermissions("fmis:pattachment2:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出定位器列表
     */
    @RequiresPermissions("fmis:pattachment2:export")
    @PostMapping("/export")
    @ResponseBody
     ...
     * 新增保存定位器
     */
    @RequiresPermissions("fmis:pattachment2:add")
     ...
     * 修改保存定位器
     */
    @RequiresPermissions("fmis:pattachment2:edit")
     ...
     * 删除定位器
     */
    @RequiresPermissions("fmis:pattachment2:remove")
