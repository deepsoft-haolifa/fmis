 ...
 */
@Controller
@RequestMapping("/fmis/pattachment1")
public class BizProductAttachment1Controller extends BaseController {
    private String prefix = "fmis/pattachment1";
    ...
    @RequiresPermissions("fmis:pattachment1:view")
    @GetMapping()
     ...
     * 查询定位器列表
     */
    @RequiresPermissions("fmis:pattachment1:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出定位器列表
     */
    @RequiresPermissions("fmis:pattachment1:export")
    @PostMapping("/export")
    @ResponseBody
     ...
     * 新增保存定位器
     */
    @RequiresPermissions("fmis:pattachment1:add")
    @Log(title = "定位器", businessType = BusinessType.INSERT)
    @PostMapping("/add")
    @ResponseBody
     ...
     * 修改保存定位器
     */
    @RequiresPermissions("fmis:pattachment1:edit")
    @Log(title = "定位器", businessType = BusinessType.UPDATE)
    @PostMapping("/edit")
    @ResponseBody
     ...
     * 删除定位器
     */
    @RequiresPermissions("fmis:pattachment1:remove")
    @Log(title = "定位器", businessType = BusinessType.DELETE)
    @PostMapping( "/remove")
    @ResponseBody
