 ...
 */
@Controller
@RequestMapping("/fmis/pattachment3")
public class BizProductAttachment3Controller extends BaseController {
    private String prefix = "fmis/pattachment3";
    ...
    @RequiresPermissions("fmis:pattachment3:view")
    @GetMapping()
     ...
     * 查询定位器列表
     */
    @RequiresPermissions("fmis:pattachment3:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出定位器列表
     */
    @RequiresPermissions("fmis:pattachment3:export")
    @PostMapping("/export")
    @ResponseBody
     ...
     * 新增保存定位器
     */
    @RequiresPermissions("fmis:pattachment3:add")
     ...
     * 修改保存定位器
     */
    @RequiresPermissions("fmis:pattachment3:edit")
     ...
     * 删除定位器
     */
    @RequiresPermissions("fmis:pattachment3:remove")
