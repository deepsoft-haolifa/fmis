 ...
 */
@Controller
@RequestMapping("/fmis/pattachment")
public class BizProductAttachmentController extends BaseController {
    private String prefix = "fmis/pattachment";
    ...
    @RequiresPermissions("fmis:pattachment:view")
    @GetMapping()
     ...
     * 查询定位器列表
     */
    @RequiresPermissions("fmis:pattachment:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出定位器列表
     */
    @RequiresPermissions("fmis:pattachment:export")
    @PostMapping("/export")
    @ResponseBody
     ...
     * 新增保存定位器
     */
    @RequiresPermissions("fmis:pattachment:add")
     ...
     * 修改保存定位器
     */
    @RequiresPermissions("fmis:pattachment:edit")
     ...
     * 删除定位器
     */
    @RequiresPermissions("fmis:pattachment:remove")
