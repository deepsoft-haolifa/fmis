package com.ruoyi.fmis.productref.mapper;
 ...
 * @date 2020-03-17
 */
public interface BizProductRefMapper {
    /**
     * 查询产品关系
     *
     ...
     * 批量删除产品关系
     *
     * @param productRefIds 需要删除的数据ID
     * @return 结果
     */
    public int deleteBizProductRefByIds(String[] productRefIds);
}
